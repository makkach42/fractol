...
OBJS = $(SRCS:.c=.o)
SRCS_BONUS = bonus/fractol_bonus.c bonus/pars_bonus.c bonus/utils_bonus.c bonus/mandelbrot_bonus.c bonus/events_bonus.c bonus/helpers_bonus.c bonus/more_helpers_bonus.c
